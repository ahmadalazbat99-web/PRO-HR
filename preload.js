...
contextBridge.exposeInMainWorld('hrpro', {
  ...
  shifts: { list: (token) => ipcRenderer.invoke('shifts:list',{token:token||activeToken}), add: (payload) => ipcRenderer.invoke('shifts:add', withToken(payload)) },
  ...
  fingerprint: { list: () => ipcRenderer.invoke('fingerprint:list'), add: (payload) => ipcRenderer.invoke('fingerprint:add', withToken(payload)), test: (payload) => ipcRenderer.invoke('fingerprint:test', withToken(payload)) },
  leaveTypes: { list: () => ipcRenderer.invoke('leaveTypes:list'), add: (payload) => ipcRenderer.invoke('leaveTypes:add', withToken(payload)) },
  ...
  leaveRequests: { list: (payload) => ipcRenderer.invoke('leaveRequests:list', withToken(payload)), add: (payload) => ipcRenderer.invoke('leaveRequests:add', withToken(payload)), approve: (payload) => ipcRenderer.invoke('leaveRequests:approve', withToken(payload)), reject: (payload) => ipcRenderer.invoke('leaveRequests:reject', withToken(payload)) },
  ...
  backup: { create: (token) => ipcRenderer.invoke('backup:create', {token: token || activeToken}), restore: (token) => ipcRenderer.invoke('backup:restore', {token: token || activeToken}) },
  ...
  documents: { list:(token)=>ipcRenderer.invoke('documents:list',{token: token || activeToken}), add:(p)=>ipcRenderer.invoke('documents:add',withToken(p)) },
  ...
  notifications: { list:(token)=>ipcRenderer.invoke('notifications:list',{token: token || activeToken}), readAll:(token)=>ipcRenderer.invoke('notifications:readAll',{token: token || activeToken}), create:(p)=>ipcRenderer.invoke('notifications:create',withToken(p)), delete:(p)=>ipcRenderer.invoke('notifications:delete',withToken(p)), unreadCount:(token)=>ipcRenderer.invoke('notifications:unreadCount',{token: token || activeToken}) },
